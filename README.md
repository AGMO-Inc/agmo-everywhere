...
**Claude Code 플러그인 — 7개 에이전트, 23개 온디맨드 스킬, Obsidian 중심 워크플로우**

[![Version](https://img.shields.io/badge/version-0.4.0-blue.svg)](https://github.com/AGMO-Inc/agmo-everywhere/releases/tag/v0.4.0)
[![Agents](https://img.shields.io/badge/agents-7-green.svg)](#에이전트-agents)
[![Skills](https://img.shields.io/badge/skills-23-orange.svg)](#스킬-카탈로그-skills)
